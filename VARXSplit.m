...
data=xlsread('MONETARY DATASET.xlsx','ALL DATA','B2:K133');
...
[A_best, res_best, T,N] = OLS(y,optimal_p,z);
...
sgtitle('IRF Oil Kanzig Shock - VARX-Split (2007-2018)', 'FontSize', 14, 'FontWeight', 'bold');

%----------------------------%
clear all

data=xlsread('MONETARY DATASET.xlsx','ALL DATA','B134:K223');
...
sgtitle('IRF Oil Kanzig Shock - VARX-Split (2018-2025)', 'FontSize', 14, 'FontWeight', 'bold');
